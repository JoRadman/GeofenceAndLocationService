...
[assembly: Dependency(typeof(NotificationsHelp))]
namespace GeofenceAndLocationService.Droid
{
    public class NotificationsHelp : INotification
    {
        ...
        public void CreateNotification(String title, String message)
        {
            try
            {
                ...
                mBuilder.SetContentTitle(title)
                        ...
                        //.SetSmallIcon(Resource.Drawable.AksisLogoZaWorkTimeApp);
