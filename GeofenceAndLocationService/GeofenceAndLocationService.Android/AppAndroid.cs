...
namespace GeofenceAndLocationService.Droid
{
    public class AppAndroid
    {
        ...
        // declarations
        protected readonly string logTag = "AppAndroid";
        protected static LocationServiceConnection locationServiceConnection;

        // properties

        public static AppAndroid Current
        {
            get { return current; }
        }
        private static AppAndroid current;
        ...
        public static async void StartLocationService()
        {
            // Starting a service like this is blocking, so we want to do it on a background thread
            new Task(() => {

                // Start our main service
                Log.Debug("AppAndroid", "Calling StartService");
                ...
                Log.Debug("AppAndroid", "Calling service binding");
        ...
        public static void StopLocationService()
        {
            try
            {
                ...
                Log.Debug("AppAndroid", "StopLocationService");

                // Unbind from the LocationService; otherwise, StopSelf (below) will not work:
                if (locationServiceConnection != null)
                {
                    Log.Debug("AppAndroid", "Unbinding from LocationService");
                ...
                {
                    Log.Debug("AppAndroid", "Stopping the LocationService");
